...
## Project Structure
    ...
    ├── testapiautocatalog_118948  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_118948`
...
2. Clone this repo and `cd testapiautocatalog_118948`
